...
int32_t main(void)
{
	...
	FragTrap FragDima;
	DiamondTrap DiamondXan("DiamondTrap");
	...
	DiamondXan.whoAmI();
	DiamondXan.guardGate();
	DiamondXan.highFivesGuys();
	DiamondXan.attack("Dikkeman");
	DiamondXan.beRepaired(10);
	DiamondXan.takeDamage(99);
	DiamondXan.takeDamage(1);
	DiamondXan.attack("Dikkeman");
	DiamondXan.whoAmI();
